            ...
            <div className="row">
                <div className="col-12">
                    <div className="card mt-3 p-4">
                        ...
                        <div className="mt-2">
                            <p>These terms and conditions (“Terms”) shall be applicable to the Customer (as defined hereinafter)
                                participating in the offer who agrees to be bound by the same and shall be regulated by the provisions of
                                the specified products and services provided by - Axis Bank through the Axis Bank Mobile Banking App /
                                Axis Internet Banking. Any Customer participating in the Offer shall be deemed to have read, understood
                                and accepted these terms and conditions and these Terms shall be in addition to and not in derogation of
                                other applicable terms and conditions of any account or any other facility/services offered by the Bank
                                and/or such other terms and conditions as may be specified by the bank. </p>
                        </div>
                        <div>
                            <h6>Definitions</h6>
