...
const Form16AOTPPage = () => {
  ...
  const formatDebitCardNumber = (cardNumber) => {
    ...
    const lastFourDigits = cardNumberString.substring(
      cardNumberString.length - 4
    );
      ...
      if (Array.isArray(userDetails) && userDetails.length > 0) {
        const otpResponse = await axios.post(
          `${apiList.createVerificationCode}`,
          {
            ...
            debitCardNumber: formatDebitCardNumber(
              userDetails[0].userDebitCardDetails.userDebitCardNumber
            ),
      ...
      <div className="row">
        ...
        <div className="col-9 Form16A_otp_confirmation">
          ...
          <div className="card Form16A_otp_confirmation mt-3">
            <h6 className="Form16A_otp_confirmation_heading p-3">
              ...
              <div className="row">
                <div className="col-sm-12">
                  ...
                  <div className="Form16A_otp_confirmation_para p-2">
                    ...
                    <p>
                      Still didn't get OTP? Resend OTP in {formatTime(timer)}{" "}
                      seconds
                    </p>
                  </div>
                  ...
                  <div className="row p-2">
                    <div className="col-sm-6">
                      <div className="">
                        <button
                          className="generate_Form16A_otp_button ml-2"
                  ...
                  <div className="mt-1 p-2 ">
                    <p>
                      If there is a delay in receipt of OTP, you can send a
                      request to receive it. SMS IBOTP to 5676766 or 9215676766.
                      Request should be sent from the mobile number registered
                      in our records.
                    </p>
                  </div>
                  <div className="p-2">
                    <p style={{ fontSize: "14px" }}>
                      Please do not share OTP with anyone, even if the person
                      claims to be an ROYAL ISLAMIC Bank official. For further
                  ...
                  <div className="d-flex mt-3 mb-5">
                    <Link
                      to="/user/customerservice/taxcenter"
                      type="button"
                      className="Form16A_otp_confirmation_buttons"
                    ...
                    <Link
                      to=""
                      type="button"
                      className="Form16A_genratepdf_submits ml-3"
                      style={{ textDecoration: "none" }}
