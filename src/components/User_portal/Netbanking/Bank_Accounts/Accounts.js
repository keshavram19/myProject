      ...
      <div className="row">
        ...
        <div className="col-9">
          <div className="accounts_container">
            <div className="savings_account_header">
              <div className="d-flex align-items-center">
                <div className="savings_acct_type_heading">Account Type:</div>
              ...
              <div className="d-flex align-items-center">
                <div className="savings_acct_avail_bal">Available Balance:</div>
            ...
            <div className="savings_account_user_details_cont">
              ...
              <div>
                ...
                <div>
                  {accountDetails.prefix} {accountDetails.firstname}{" "}
              ...
              <div className="d-flex align-items-center">
                <button
                  onClick={accountStatement}
                  className="account_statement_view_btn"
                >
          ...
          {viewAccStatement === "true" ? (
            <div>
              <div className="d-flex align-items-center">
                <div className="acct_statement_acct_num">Account Number:</div>
              ...
              <div className="d-flex justify-content-between savings_acc_another_acct">
                <div>
                  <Link to="/user/account/statement">
          ...
          <div>
            ...
            <ul>
              <li className="savings_acct_note_points">
                The available balance mentioned reflects both the credit balance
                any existing overdraft limit, if applicable.
              </li>
              <li className="savings_acct_note_points">
                This balance does not encompass funds that are yet to be
                cleared.
              </li>
              <li className="savings_acct_note_points">
                Savings account holders now have the option to receive monthly
                statements via email at no cost. To enroll,{" "}
                <a className="savings_acc_note_atag">click</a> on the provided
                link.
              </li>
              <li className="savings_acct_note_points">
                For verification of your PAN card details, please{" "}
                <a className="savings_acc_note_atag">click</a> on the provided
                link.
              </li>
            </ul>
