...
function UpdateForm60() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const mandatoryFieldsChecked =
      formData.mandatoryfields1 &&
      formData.mandatoryfields2 &&
      formData.mandatoryfields3 &&
      formData.mandatoryfields4;

    if (!mandatoryFieldsChecked) {
      toast.warning(
        "Please check all the mandatory fields before submitting the form."
      );
      return;
    }
    try {
  ...
  const handleVerifyOtp = async () => {
    try {
      const response = await axios.post(
        `${apiList.form60OtpVerification}/${formData.EmailID}`,
        { enteredOtp }
      );
      console.log(response.data);
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const response = await axios.post(apiList.form60OTPSend, {
      ...
      <div className="container-fluid" style={{ marginTop: "90px" }}>
        <div className="side_bar_section">
          <div className="row">
            ...
            <div className="col-9">
              <div
                className="update_form_container "
              ...
              >
                ...
                <form className="update_form_section" onSubmit={handleSubmit}>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <label for="agriculturalIncome" className="form-inline">
                        <span>
                          Agricultural Income*
                          <span style={{ fontSize: "10px", color: "#929090" }}>
                  ...
                  <div className="form-check d-flex align-items-start">
                    ...
                    />
                    <label className="form-check-label form-inline m-1">
                      <p
                        style={{
                          fontSize: "16px",
                          marginBottom: "10px",
                      ...
                      >
                        I agree that, the information furnished in this form is
                        true, correct and complete in all respects. Any person
                        making a false statement in the declaration shall be
                        liable to prosecution under section 277 of the
                        Income-tax Act, 1961 and on conviction be punishable, in
                        a case where tax sought to be evaded exceeds twenty-five
                        lakh rupees, with rigorous imprisonment which shall not
                        be less than six months but which may extend to seven
                        years and with fine; in any other case, with rigorous
                  ...
                  <div className="form-check d-flex align-items-start">
                    ...
                    <label className="form-check-label form-inline m-1">
                      ...
                      >
                        ...
                        the best of my knowledge and belief. I further declare
                        that I do not have a Permanent Account Number and my/
                        our estimated total income (including income of spouse,
                        minor child etc. as per section 64 of Income-tax Act,
                        1961) computed in accordance with the provisions of
                        Income-tax Act, 1961 for the financial year in which the
                        above transaction is held will be less than maximum
                  ...
                  <div className="form-check d-flex align-items-start">
                    ...
                    <label className="form-check-label form-inline m-1">
                      ...
                      >
                        The information in the Form 30 shall be applicable to
                        all accounts held by me/us.
                      </p>
                    </label>
                  </div>
                  ...
                  <div className="form-check d-flex align-items-start">
                    ...
                    <label className="form-check-label form-inline m-1">
                      ...
                      >
                        Option 4I agree that the declaration will not be
                        accepted where the amount of income of the nature
                        referred to in item 22b exceeds the maximum amount which
                        is not chargeable to tax, unless PAN is applied for and
                        column 21 filled.
                      </p>
                    </label>
                  </div>
                  ...
                  <div
                    ...
                    style={{ fontSize: "16px" }}
                  >
                    <label className="form-check-label form-inline" for="SMS">
                      <input
                        type="radio"
                        id="SMS"
                        className="form-check-input"
                  ...
                  <div
                    ...
                    style={{ fontSize: "16px" }}
                  >
                    <label className="form-check-label form-inline" for="Email">
                      <input
                        type="radio"
                        id="Email"
                        className="form-check-input "
                  ...
                  <div
                    ...
                    style={{ fontSize: "15px" }}
                  >
                    <label className="form-check-label form-inline" for="call">
                      <input
                        type="radio"
                        className=" form-check-input "
                        id="call"
                  ...
                  <div>
                    <p style={{ fontSize: "12px" }}>
                      <i>
                        OTP Will be sent to registered mobile number xxxxxxx345
                      </i>
                    </p>
                  </div>
                  <button
                    type="button"
                    className="update_form_sendOtp_btn p-1 m-3"
                  ...
                  <input
                    ...
                    className="Update_form60_Otp m-0 text-center"
                    name="enteredOtp"
                    value={enteredOtp}
                  ...
                  <hr />
                  <div className="p-1">
                    <button className="update_form_back_btn p-2" type="button">
                      BACK
                    </button>

                    <button
                      className="update_form_submit_btn p-2"
