...
const Statements = () => {
  ...
  const generatePDF = () => {
    ...
    const footerInfo = `
        ...
        `;
    const transactionTableHTML = transactionRef.current
      ? transactionRef.current.innerHTML
      : "";
  ...
  const fetchTransactions = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        const formattedTransactions = responseData.transactions.map(
          (transaction) => ({
            ...transaction,
          ...
          <div className="acct_statements_months_cont">
            ...
            <div className="acct_type_cont">
              ...
              <div className="d-flex align-items-center">
                <select
                  className="form-control statement_select_format"
            ...
            <div className="d-flex period_cont">
              ...
              <input
                type="radio"
                id="period"
                className="period_radio_btn"
                disabled={accountType === "Current"}
                name="radioBtn"
                value="2"
                onChange={handlePeriodRange}
              ></input>
              <div className="d-flex align-items-center period_data_cont"></div>
              <div>
                <div className="mb-2 d-flex align-items-center">
                  ...
                  <div className="d-flex align-items-center">
                    <DatePicker
                      ...
                      className="from_date_period"
                      disabled={periodRangeStatus === false}
                      selectsStart
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <FcCalendar
                      className="calender_icon"
                      onClick={() => datePickerReference.current.setOpen(true)}
                    />
                  </div>
                </div>
              </div>
            ...
            <input type='radio' id='period' className='period_radio_btn'
              ...
              <div>
                <div className="mb-2 d-flex align-items-center ">
                  <div className="show_transactions_text">
                    Show Transactions:
                  </div>
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="show_all_tra">
                    <select
                      className="form-control statement_select_format"
                      disabled={accountType === "Current"}
                      onChange={handlePerPageTransactions}
                    >
            ...
            <div className="transactions_view_btn_cont">
              <button
                className="transactions_view_btn"
                type="button"
                onClick={handleTransStatement}
              >
                View
              </button>
            </div>
          ...
          {reverseTransactions.length > 0 && (
            <div className="my-5">
              <div>
                <div className="d-flex justify-content-between">
                  ...
                  <div className="d-flex">
                    <div>
                      <AiFillPrinter className="acct_statement_printer_icon" />
                    </div>
                    <div className="acct_statement_printer_text">
                      Print This Page
                    </div>
                  </div>
                </div>
                <div className="d-flex statement_savings_acct_num_cont">
                  <div className="statement_savings_acct_num">
                    Savings Account No:{" "}
                  </div>
              ...
              <div className="d-flex justify-content-end">
                <div className="tran_statement_closing_bal">
                  Closing Balance:
                </div>
              ...
              <div>
                <button
                  type="button"
                  className="statement_download_btn"
                ...
                <button
                  type="button"
                  className="statement_download_btn ml-3"
          ...
          <div>
            ...
            <ul>
              <li className="savings_acct_statement_note_points">
                Transactions can be viewed or downloaded for the selected period
                only.
              </li>
              <li className="savings_acct_statement_note_points">
                User can navigate through transaction pages, with each page
                displaying up to 20 transactions.
              </li>
              <li className="savings_acct_statement_note_points">
                If the total number of transactions exceeds 2000 for a period of
                six months or less, the statement can be downloaded in parts by
                adjusting the date range accordingly.
              </li>
              <li className="savings_acct_statement_note_points">
                Remember to confirm your selection by clicking on the 'Select
                Period' option to save and download the account statement.
              </li>
            </ul>
          </div>
        </div>
