    ...
    <>
      <div className="ViewPayee-container">
        <div className=" BankAccount_navbar">
          <div
            className={
              activeTab === "Other Royal Islamic Banks Account"
                ? "deletePayee_buttonon"
                : ""
            }
            onClick={() => setActiveTab("Other Royal Islamic Banks Account")}
          >
            Other Royal Islamic Bank Accounts
          </div>
          <div
            className={
              activeTab === "Other Bank Accounts" ? "deletePayee_buttonon" : ""
            }
            onClick={() => setActiveTab("Other Bank Accounts")}
          >
            Other Bank Accounts
          </div>
          <div
            className={
              activeTab === "Virtual Account" ? "deletePayee_buttonon" : ""
            }
          ...
          <div
            className={
              activeTab === "Pending Payee" ? "deletePayee_buttonon" : ""
            }
            onClick={() => setActiveTab("Pending Payee")}
          >
            Pending Payees
          </div>
        </div>
        ...
        <div className="BankAccount_frompages_container">
          <div class="row mb-3">
            ...
            <div className="col-md-10">
              <input
                type="text"
                className="BankAccount_inputAccount_container"
              ></input>
            </div>
          </div>
          <div class="row mb-3">
            ...
            <div clas="col-md-10">
              <input
                type="text"
                className="BankAccount_inputNickName_container"
              ></input>
            </div>
          </div>
        ...
        <div className="BankAccount_NoteParagraph_container">
          <p>Notes:</p>
          <p>
            1. Registration has been disabled due to one of the following
            reason:
          </p>
