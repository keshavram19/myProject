...
const CreditCard = () => {
    ...
    useEffect(() => {
        if (individualCreditCard && individualCreditCard.creditCardLimit) {
            setCreditLimit(parseInt(individualCreditCard.creditCardLimit, 10));
        }
    }, [individualCreditCard.creditCardLimit]);
                        ...
                        <Tab.Content>
                            <Tab.Pane eventKey="#link1">
                                {customerAccData.length > 0 ?
                                            ...
                                            <div className='my-2'>
                                                ...
                                                <div class="progress my-2">
                                                    <div className='progress-bar'
                                                        style={{
                                                            width: `${(individualCreditCard.totalAmountDue / individualCreditCard.creditCardLimit) * 100}%`,
                                                            backgroundColor: 'red'
                                                        }}>
                                                    ...
                                                    <div className='progress-bar'
                                                        style={{
                                                            width: `${(individualCreditCard.currentOutstanding / individualCreditCard.creditCardLimit) * 100}%`,
                                                    ...
                                                    <div className='progress-bar'
                                                        style={{
                                                            width: `${(individualCreditCard.availableCreditLimit / individualCreditCard.creditCardLimit) * 100}%`,
                                    ...
                                    : 
                                    (<div className='view_your_card_noCard'>No Active Credit Card</div>)
                                }
                            </Tab.Pane>
                            <Tab.Pane eventKey="#link2">
                                {customerAccData.length > 0 ?
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <div className='d-flex align-items-center mt-2'>
                                                                ...
                                                                <div className='ml-2'>{creditLimit}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    :
                                    (<div className='view_your_card_noCard'>
