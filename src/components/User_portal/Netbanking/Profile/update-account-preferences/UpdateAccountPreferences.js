                    ...
                    <div className='row'>
                        ...
                        <div className="col-9 accounts_preferences">
                            ...
                            <div className="services">
                                ...
                                <div>
                                    <table className="account_preferences_table_head
                ">
                                        <tbody>
                                    ...
                                    <div>
                                        ...
                                        <button className='account_preferences_button'>Set as primary</button>
                                        <button className='account_preferences_button ml-2'><Link to="/user/profile/changenickname"> Update account nick name</Link></button>
                                </div>
                                </div>
