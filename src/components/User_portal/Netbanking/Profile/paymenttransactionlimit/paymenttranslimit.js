...
function PaymentTransactionLimit() {
  ...
  return (
    ...
    <select
        className="form-control credit_card_limit_range"
        value={selectedAccount}
        onChange={handleAccountChange}
        style={{ fontSize: "16px" }} // Add this line to set the font size
    >
        ...
        {userDetails.map((account, index) => (
            <option key={index} value={account.accountNumber}>
                ...
                <div className="row card_details_paymenttransferLimit_select_tag mt-2">
                  ...
                  <div className="col-sm-4" >
                    <select
                      ...
                      onChange={(event) =>
                        setSelectedDebitCard(event.target.value)
                      }
                    >
                      ...
                      {userDetails.length > 0 &&
                        userDetails[0].userDebitCardDetails && (
                          <option
                            value={formatDebitCardNumber(
                              userDetails[0].userDebitCardDetails
                                .userDebitCardNumber
                            )}
                          >
                            {formatDebitCardNumber(
                              userDetails[0].userDebitCardDetails
                                .userDebitCardNumber
                            )}
                          </option>
                ...
                <div
                  className="existing_debit_card_limit p-1"
                  style={{ fontSize: "15px" }}
                >
                  {" "}
                  Existing debit Limit:
                </div>
                ...
                <div
                  ...
                  className="p-1"
                >
                  Select your desired daily debit limit
                </div>
                <div className="form-group p-1">
                  <label
                    htmlFor="formControlRange p-1"
                  ...
                  <div className="d-flex align-items-center1 mt-2 p-1">
                    <div style={{ fontSize: "15px" }}>
                      Selected Debit Limit:{" "}
                    </div>
