...
function InwardRemitance() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      alert(
        "Please fill in all the details completely and review the information for accuracy by checking the checkbox."
      );
      ...
      <div className="container-fluid" style={{ marginTop: "90px" }}>
        <div className="Inward_Remitance_container">
          <div className="row">
            ...
            <div className="col-9">
              <p className="Inward_smart_wire_ptag">
                SMART WIRE
                <p className="bankingapp_inward_ptag">
                  Receiving money from overseas just got simpler & smarter !
                </p>
              </p>
              <div className="Inward_benefits">
                <p className="Inwbenifits_tag_hfive">
                  Benefits of Inward Wire Transfer
                </p>
                <div className="inward_ullist">
                  <ul className="inward_remitance_flex">
                    <li>
                      <span className="inward_span_tag_main">
                    ...
                    <li>
                      <span className="inward_span_tag_main">
                        <i class=" icons_inwardrem fa-solid fa-jar fa-xl"></i>
                        Pre-filled{" "}
                      </span>{" "}
                      information
                    </li>
                  ...
                  <ul className="inward_remitance_flex">
                    <li>
                      <span className="inward_span_tag_main">
                        <i class="icons_inwardrem fa-solid fa-money-bill-transfer fa-xl"></i>
                        Online tracking{" "}
                      </span>
                      of your money
                    </li>
                    ...
                    <li>
                      <span className="inward_span_tag_main">
                        <i class=" icons_inwardrem fa-solid fa-hand-holding-dollar fa-xl"></i>
                        Option to fix{" "}
                      </span>{" "}
                      exchange rates
                    </li>
                ...
                <div className=" Inward_box_type_select row">
                  <div className="Inward_pink_box_request pt-3 col-sm-4">
                    ...
                    <div className="Inward_four_main_lists  ml-3">
                      <p className="Inward_four_lists">
                        <span className="one_inward">1</span> Enter transfer
                        details
                      </p>
                      <p className="Inward_four_lists">
                        <span className="two_inward">2</span> Submit details
                        /declerations
                      </p>
                      <p className="Inward_four_lists">
                        <span className="two_inward">3</span> Option to book FX
                        deal
                      </p>
                      <p className="Inward_four_lists">
                        <span className="four_inward">4</span> Share request
                        form
                      </p>
                    </div>
                  </div>
                  <div className="Inward_pink_side_box col-sm-4 pt-3">
                    <p className="Inward_four_lists">
                      Select account number for receiving the remittance
                    </p>

                    <div className="Inward_part_two"></div>
                    <p className="Inward_four_lists  mt-1 ">
                      Go ahead! submit details to receive remittance with Royal
                      Islamic Bank SMART WIRE service
                    </p>
                  </div>
                  <div className="mt-3">
                    <p className="Inward_remittance_Request_Form_one">
                      Enter Transfer Details:
                    </p>
                    <form
                      className="Inward_remittance_Request_Form"
                    ...
                    >
                      ...
                      >
                        ...
                        <option value={transferDetails.accountNumber}>
                          {transferDetails.accountNumber}
                        </option>
                      </select>
            ...
            >
             ...
             <option value="number">{accountNumber}</option>
              ...
              <option value="987654321">987654321</option> 
                      ...
                      <p className="Inward_remittance_Request_Form_one_Sub">
                        Submit Details/Declarations:
                      </p>
                      <label className="Inward_remittance_Request_form_checkbox">
                        ...
                        />
                        <p className="Inward_remittance_Request_form_ptag_Del">
                      ...
                      <label className="Inward_remittance_Request_form_checkbox">
                        ...
                        <p className="Inward_remittance_Request_form_ptag_Del">
                          Option to Book FX Deal
                        </p>
                      </label>
                      {/* Other fields for FX deal... */}

                      <p className="Inward_remittance_Request_one">
                        Share Request Form:
                      </p>
                      <button
                        className="Inward_remittance_Request_form_ptag"
                        type="submit"
