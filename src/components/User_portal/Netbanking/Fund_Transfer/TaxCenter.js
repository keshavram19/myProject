...
const TaxCenter = () => {
  ...
  const verifyOTP = async () => {
    ...
    try {
      ...
      const response = await axios.post(apiList.taxOTPVerify, {
        mobileNumber,
        otp,
      });
      setMessage(response.data.message);
        ...
        <div className="row">
          ...
          <div className="col-9">
            <div className="tax_centerbank_page col-sm-12">
              ...
              <div className="user_authenti_tax_header card ">
                <p className="user_header_tax_color">
                ...
                <div className="light_bg_color_tax">
                  ...
                  <div className="pl-2">
                    <p className="Tax_ptag_please_para">
                      ...
                      <p className="Tax_ptag_please_para mt-2">
                        Click on the Generate OTP button to get the OTP to your
                        registered mobile number
                      </p>
                    </p>
                    <div className=" Tax_ptag_please_para"></div>
                    <div>
                      <input
                      ...
                      {!showResendButton ? (
                        <button
                          className="Tax_center_but_appGen mr-3"
                          onClick={generateOTP}
                        >
                          Generate OTP
                        </button>
                        ...
                        <>
                          ...
                          <button
                            className="Tax_center_but_appGen"
                            onClick={verifyOTP}
                          >
                            Verify OTP
                          </button>
                    ...
                    <p className="otp_tax_matters">
                      OTP has been generated with a validity of 100 seconds and
                      sent to your registered mobile number.
                      <p className="otp_tax_matters">
                        {" "}
                        If there is a delay in receipt of OTP, you can send a
                        request to receive it. SMS IBOTP to 5575700 or
                        9215676708. Request should be sent from the mobile
                        number registered in our records.
                        <p className="otp_tax_matters">
                          Please do not share OTP with anyone, even if the
                          person claims to be an Royal Islamic Bank official.For
                          further details Please
                          <span className="Tax_click_here_span">
                            {" "}
                            click here{" "}
                          </span>
                        </p>
