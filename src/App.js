  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/netbanking-personal-login" element={<PersonalLoginPage />} />
        <Route path="/netbanking-corporate-login" element={<CorporateLoginPage />} />
        ...
        <Route path='/user/account/statement-by-email' element={<StatementByMail />} />
        <Route path='/user/account/debit-atm-card' element={<DebitAndAtm />} />
        <Route path='/user/account/generate-debitcard-pin' element={<GeneratePin />} />
        <Route path='/user/account/block-debit-card' element={<BlockCard />} />
        <Route path='/user/account/reissue-card' element={<Reissuecard />} />
        <Route path='/user/account/manage-cardlimit' element={<ManageCardLimit />} />
        <Route path='/user/account/chequebook-req' element={<ChequeBookReq />} />
        <Route path='/user/account/view-update-pancard' element={<ViewAndUpdatePancard />} />
        <Route path='/user/account/update-form60' element={<UpdateForm60 />} />
        <Route path='/user/account/pmsocial-securityschmes' element={<PMSocialSecuritySchemes />} />
        <Route path='/user/account/bank-rewardspoints' element={<BankRewardPoints />} />
        <Route path='/user/account/service-request' element={<ServiceRequest />} />
        <Route path='/user/account/fixed-deposits' element={<FixedDeposit />} />
        <Route path='/user/account/reccuring-deposits' element={<RecurringDeposit />} />
        <Route path='/user/account/iwish-deposits' element={<IWishDeposits />} />
        ...
        <Route path='/user/fundtransfer/transaction-status' element={<TransactionStatus />} />
        <Route path='/user/fundtransfer/scheduled-transaction' element={<ScheduledTransaction />} />
        <Route path='/user/fundtransfer/completed-transaction' element={<CompletedTransaction />} />
        <Route path='/user/fundtransfer/payment-summary' element={<PaymentSummary />} />
        <Route path='/user/fundtransfer/wire-transaction' element={<WireTransaction />} />
        <Route path='/user/fundtransfer/upi-transaction-status' element={<UpiTransaction />} />
        <Route path='/user/fundtransfer/quickfundtransfer' element={<QuickFundTransfer />} />
        <Route path='/user/fundtransfer/generate-mmid' element={<GenerateMMID />} />
        <Route path='/user/fundtransfer/manage-payees' element={<ManagePayees />} />
        <Route path='/user/fundtransfer/confirm-biller' element={<ConfirmBiller />} />
        <Route path='/user/fundtransfer/confirm-payee' element={<ConfirmPayee />} />
        <Route path='/user/fundtransfer/inward-remitance' element={<InwardRemitance />} />
        <Route path='/user/fundtransfer/tax-center' element={<TaxCenter />} />
        <Route path="/user/fundtransfer/interest-certificate" element={<InterestCertificate/>}/>
        <Route path="/user/fundtransfer/disclaimer" element={<Disclaimer/>}/>
        <Route path="/user/fundtransfer/tax-payment" element={<TaxPayment/>}/>
        <Route path="/user/fundtransfer/incometax-Efill" element={<IncomeTaxEfill/>}/>
        <Route path="/user/fundtransfer/bill-recharge" element={<BillRechargeFastag/>}/>
